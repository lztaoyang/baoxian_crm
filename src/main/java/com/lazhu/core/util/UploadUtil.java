...
import com.lazhu.core.support.ftp.SftpClient;
...
public final class UploadUtil {
    ...
    public static List<String> uploadFile(HttpServletRequest request) {
        ...
        if (multipartResolver.isMultipart(request)) {
            ...
            String pathDir = request.getSession().getServletContext().getRealPath(uploadFileDir + date);
            ...
            while (iterator.hasNext()) {
                ...
                if (multipartFile != null) {
                    ...
                    try {
                        ...
                        fileNames.add(date + File.separator + name);
                    } catch (Exception e) {
