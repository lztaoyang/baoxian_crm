...
public final class WebUtil {
	...
	/** 保存当前用户 */
	public static final void saveCurrentUserType(String user) {
		setSession(Constants.CURRENT_USER_TYPE, user);
	}
	
	public static final String getCurrentUserType(){
		...
		if (null != currentUser) {
			try {
                ...
                if (null != session) {
                	return (String) session.getAttribute(Constants.CURRENT_USER_TYPE);
                }
