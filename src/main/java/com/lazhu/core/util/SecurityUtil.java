...
import com.lazhu.core.support.security.BASE64Encoder;
import com.lazhu.core.support.security.coder.DESCoder;
import com.lazhu.core.support.security.coder.HmacCoder;
import com.lazhu.core.support.security.coder.MDCoder;
import com.lazhu.core.support.security.coder.RSACoder;
import com.lazhu.core.support.security.coder.SHACoder;
...
public final class SecurityUtil {
	...
	public static final byte[] decryptBASE64(String key) {
		try {
			...
			throw new RuntimeException("解码错误，错误信息：", e);
		}
	}
	...
	public static final String encryptRSAPrivate(String data, String privateKey) {
		try {
			...
			throw new RuntimeException("私钥加密错误，错误信息：", e);
		}
	}
	...
	public static final String decryptRSAPrivate(String cryptData, String privateKey) {
		try {
			...
			throw new RuntimeException("私钥解密错误，错误信息：", e);
		}
	}
	...
	public static final String decryptRSAPublic(String cryptData, String publicKey) {
		try {
			...
			throw new RuntimeException("公钥解密错误，错误信息：", e);
		}
	}
	...
	public static void main(String[] args) throws Exception {
		...
		//System.out.println(SecurityUtil.decryptRSAPrivate("31A9HVK8xjIXfKKhCzZox7==",RSACoder.PRIVATE_KEY));
		//System.out.println(SecurityUtil.decryptRSAPublic("J6bfcRM95vscj5GsiL080M==",RSACoder.PUBLIC_KEY));
...
//		System.out.println(encryptSHA("1"));
		...
		String encrypt = "rJjz9UPguB4l8A1GTQJ2E4lai6pXsYP9GkHT77iBPuHDnzxBfR1heca05fXi653/J6bfcRM95vscj5GsiL080M==";
		String org = decryptRSAPublic(encrypt, RSACoder.PUBLIC_KEY);
	 ...
	 * @return
	 */
	public static final String encryptSHA256(String data) {
		if(data != null){
			try {
				return Hex.encodeHexString(SHACoder.encodeSHA256(data.getBytes(CHARSET)));
			} catch (Exception e) {
				throw new RuntimeException("加密错误，错误信息：", e);
			}
		}else{
