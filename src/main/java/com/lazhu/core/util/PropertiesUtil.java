...
public final class PropertiesUtil extends PropertyPlaceholderConfigurer {
    ...
    public static void main(String[] args) {
        ...
        //String encrypt = SecurityUtil.encryptDes("LoPrTB2gHEW/a4ysDqnGfa==", KEY);
        //String encrypt = SecurityUtil.encryptDes("Shecui20180208hh", KEY);
    	String encrypt = SecurityUtil.encryptDes("insurance_CRM^_^@everyB0dy", KEY);
        System.out.println(encrypt);
        //System.out.println(SecurityUtil.decryptDes("LoPrTB2gHEW/a4ysDqnGfa==", KEY));
        System.out.println(SecurityUtil.decryptDes("9re0kkyuxtigAPp8Ezah/uA4lsO3aOlhu/Fjh1L8wCY=", KEY));
    }
}
