...
public abstract class BaseService<T extends BaseModel> {
	...
	/** 插入数据 **/
	@Transactional
	public T insertPolicy(T record) {
		mapper.insert(record);
		record = mapper.selectById(record.getId());
		return record;
	}
	...
	/** 更新数据 **/
	@Transactional
	public T updatePolicy(T record) {
		mapper.updateById(record);
	...
	/** 分页查询 */
	public static Page<Map<String, String>> getPageMap(Map<String, Object> params) {
		Integer current = 1;
		Integer size = 10;
		String orderBy = null;
		boolean asc = false;
		...
		Page<Map<String, String>> page = new Page<Map<String, String>>(current, size, orderBy);
		page.setAsc(asc);
		return page;
	}
	
	/** 分页查询 */
	public Page<T> getPageBean(Map<String, Object> params) {
		Integer current = 1;
		Integer size = 10;
		String orderBy = null;
		boolean asc = false;
