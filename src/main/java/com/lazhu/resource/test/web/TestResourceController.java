package com.lazhu.resource.test.web;
...
@RequestMapping(value = "resource/test")
public class TestResourceController extends BaseController<TestResource> {
	...
	public Object get(ModelMap modelMap, @RequestBody TestResource param) {
	...
	public Object update(ModelMap modelMap, @RequestBody TestResource param) {
