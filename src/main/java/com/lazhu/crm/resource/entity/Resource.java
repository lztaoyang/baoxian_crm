...
public class Resource extends BaseModel {
    ...
    @ApiModelProperty(value = "是否共享池分配", required = false)
    @TableField("is_sharedpool_allot")
    private Integer isSharedpoolAllot;
    
    @ApiModelProperty(value = "搜索关键词", required = false)
    @TableField("keywords")
    private String keywords;
    
    @ApiModelProperty(value = "是否导入", required = false)
    @TableField("is_add")
    private Integer isAdd;
    
    @ApiModelProperty(value = "是否已添加微信", required = false)
    @TableField("is_add_chat")
    private Integer isAddChat;
    
    @ApiModelProperty(value = "添加微信时间", required = false)
    @TableField("add_chat_time")
    private Date addChatTime;
	...
	public Integer getIsSharedpoolAllot() {
		return isSharedpoolAllot;
	}

	public void setIsSharedpoolAllot(Integer isSharedpoolAllot) {
		this.isSharedpoolAllot = isSharedpoolAllot;
	}
	...
	public Integer getIsAddChat() {
		return isAddChat;
	}

	public void setIsAddChat(Integer isAddChat) {
		this.isAddChat = isAddChat;
	}
	...
	public void setAddChatTime(Date addChatTime) {
		this.addChatTime = addChatTime;
	}
