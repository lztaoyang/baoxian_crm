package com.lazhu.crm.worktrailabnormal.entity;
 ...
 * @since 2018-02-01
 */
@ApiModel(value = "市场部异常工作轨迹表",description="workTrailAbnormal")
@TableName("crm_work_trail_abnormal")
public class WorkTrailAbnormal extends BaseModel {
  ...
  //enter_time 入库时间 
	...
	public boolean equals(Object that) {
		...
		WorkTrailAbnormal other = (WorkTrailAbnormal) that;
		return (1==1
