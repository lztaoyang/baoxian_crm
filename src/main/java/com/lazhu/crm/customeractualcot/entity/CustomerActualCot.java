package com.lazhu.crm.customeractualcot.entity;
 ...
 * @since 2018-11-16
 */
@ApiModel(value = "",description="customerActualCot")
@TableName("crm_customer_actual_cot")
public class CustomerActualCot extends BaseModel {
