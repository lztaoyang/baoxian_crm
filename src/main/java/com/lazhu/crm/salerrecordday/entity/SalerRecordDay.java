package com.lazhu.crm.salerrecordday.entity;
 ...
 * @since 2018-04-13
 */
@ApiModel(value = "市场部通话记录今天表",description="salerRecordDay")
@TableName("crm_saler_record_day")
public class SalerRecordDay extends BaseModel {
