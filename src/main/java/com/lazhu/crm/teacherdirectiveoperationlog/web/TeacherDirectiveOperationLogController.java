package com.lazhu.crm.teacherdirectiveoperationlog.web;
...
@RequestMapping(value = "crm/teacherDirectiveOperationLog")
public class TeacherDirectiveOperationLogController extends BaseController<TeacherDirectiveOperationLog> {
	...
	public Object get(ModelMap modelMap, @RequestBody TeacherDirectiveOperationLog param) {
	...
	public Object update(ModelMap modelMap, @RequestBody TeacherDirectiveOperationLog param) {
