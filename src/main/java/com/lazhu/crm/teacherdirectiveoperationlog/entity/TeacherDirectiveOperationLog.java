package com.lazhu.crm.teacherdirectiveoperationlog.entity;
 ...
 * @since 2018-11-16
 */
@ApiModel(value = "",description="teacherDirectiveOperationLog")
@TableName("crm_teacher_directive_operation_log")
public class TeacherDirectiveOperationLog extends BaseModel {
    private static final long serialVersionUID = 1L;
    //teacher_directive_cot_id 老师指导操作ID 
    @ApiModelProperty(value = "老师指导操作ID", required = false)
    @TableField("teacher_directive_cot_id")
    private Long teacherDirectiveCotId;
    //stock_code 股票代码 
    ...
    public void setTeacherDirectiveCotId(Long teacherDirectiveCotId)
    {
        this.teacherDirectiveCotId = teacherDirectiveCotId;
    }

    public Long getTeacherDirectiveCotId()
    {
        return this.teacherDirectiveCotId;
    }
