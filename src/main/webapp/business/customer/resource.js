	...
	*/
    var vuePage = new Vue({
        ...
        data: {
            ...
            //查询参数
            searchParams: {fromInfo:'',name:'',mobile:'',createtime:'',wechatNo:'',qq:'',subordinate:'',salerId:'',isAddChat:'',},
            //分页数据,其中包含分页信息与数据列表
            pageData: {},
            ...
            //当前操作的实体（编辑/新增）
            entity: {name:'',fromInfo:'',wechatNo:'',mobile:'',qq:'',fuzzyMobile:'',md5Mobile:'',birthday:'',sex:'',duty:'',remark:'',demand:'',isAddChat:'',},
////////////申请签单的实体（编辑/新增）
...
//////////////申请签单表单校验规则 
        ...
        created: function () {
        	...
        	if (userGroup != null && (userGroup == 88002003 ||　userGroup == 88002005 ||　userGroup == 10000000)) {
...
////////////申请签单
          ...
          //详情页内拨打电话
            ...
            changeDetail: function (entityId) {
            	var self = this;
            	self.entity = {name:'',fromInfo:'',wechatNo:'',mobile:'',fuzzyMobile:'',md5Mobile:'',birthday:'',sex:'',duty:'',remark:''};
          ...
          //清空并刷新数据
            ...
            isAddChatFormat : function (isAddChat) {
            	return isAddChat=="1"?"已添加微信":"未添加微信";
            },
            isAddChatPlain : function (isAddChat) {
            	return isAddChat=="1"?false:true;
            },
            
          //已/未添加微信
            isAddChat : function (entityId,isAddChat) {
            	var self = this;
				...
				self.entity = {};
            	self.entity.id = entityId;
            	self.entity.isAddChat = isAddChat=="1"?"0":"1";
