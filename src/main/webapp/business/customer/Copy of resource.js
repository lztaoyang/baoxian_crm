	...
	*/
    var vuePage = new Vue({
        ...
        data: {
            ...
            //当前操作的实体（编辑/新增）
            entity: {name:'',fromInfo:'',wechatNo:'',mobile:'',qq:'',fuzzyMobile:'',md5Mobile:'',birthday:'',sex:'',duty:'',remark:''},
////////////申请签单的实体（编辑/新增）
...
//////////////申请签单表单校验规则 
        ...
        methods: {
            //查询
            readList: function (flowId) {
            	this.changeTopFlow(flowId);
            	var params = {};
            	params = {
            			asc: false,
            			orderBy: "create_time",
            	...
            	if (flowId == 0) {
					this.showResourceFlow = true;
					flowId= "";
				}
            	if (flowId == -1) {
					flowId = this.currentListFlow;
				}
            	params['flowId'] = flowId;
            	this.currentListFlow = flowId;
                //将查询条件合并到请求参数中
            ...
            addSave: function () {
            	...
            	if (userGroup != null && (userGroup == 10000000 || userGroup == 88002005)) {
          ...
          //详情页内拨打电话
            ...
            handleClose : function () {
            	...
            	if (!self.showSaveButton) {
            		...
            		self.readList(self.currentListFlow);
            ...
            changeTopFlow : function (flowId) {
            	if (flowId >= 0) {
            		...
            		self.flow301 = true;
            		self.flow501 = true;
            		self.extractButten = true;
            		self.showResourceFlow = false;
            		if (flowId == 101) {
            			self.flow101 = false;
            		} else if (flowId == 201) {
            			self.flow201 = false;
