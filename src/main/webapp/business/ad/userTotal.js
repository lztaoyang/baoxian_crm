	...
	*/
    var vuePage = new Vue({
        ...
        data: {
            ...
            //查询参数
            searchParams: {startTime:'',endTime:'',userType:'3',},
            //分页数据,其中包含分页信息与数据列表
            pageData: {},
            //表格中选中的行的集合
            selectDatas: [],
            options:[{label:'总经理',value:'0'},{label:'总监',value:'1'},{label:'经理',value:'2'},{label:'业务员',value:'3'}],
        ...
        methods: {
            ...
            readList: function () {
                ...
                this.$http.put(this.sourceUrl+'/read/userTotal', params)
