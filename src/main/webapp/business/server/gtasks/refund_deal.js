	...
	*/
    var vuePage = new Vue({
        ...
        data: {
            ...
            //退保实体（详情）
            refundEntity1: {customerId:'',signApplyId:'',belong:'',companyName:'',customerName:'',dealerResult:'',remark:'',createTime:'',insuranceName:'',applyTime:'',amount:'',policyNo:'',dealerName:'',updateTime:''},
            //通话记录实体
