	...
	*/
    var vuePage = new Vue({
        el: '#app',
        data: {
        	sourceUrl:"demo/example",
            //是否显示编辑窗口
            editFormVisible: false,
            //是否显示详情窗口
            detailFormVisible: false,
            //查询参数
            searchParams: {tBigtxt:'',tMiddletxt:'',tSmalltxt:'',tInt:'',tLong:'',tFloat:'',sex:'',tDate:'',tDatetime:'',tBoolean:'',},
            //分页数据,其中包含分页信息与数据列表
            pageData: {},
            //当前操作的实体（编辑/新增）
            entity: {tBigtxt:'',tMiddletxt:'',tSmalltxt:'',tInt:'',tLong:'',tFloat:'',sex:'',tDate:'',tDatetime:'',tBoolean:'',},
            //表格中选中的行的集合
            selectDatas: [],
            //表单校验规则 api:https://github.com/yiminghe/async-validator
            rules: {
	    		tBigtxt: [
	    		Vali.utf8mb4Len(false,65535)
	    	],
	    		tMiddletxt: [
	    		Vali.utf8mb4Len(false,1000)
	    	],
	    		tSmalltxt: [
